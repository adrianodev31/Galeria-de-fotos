...
export const ImagemGrande = ({img, callBack, callBackAlterandoFoto}: Props) => {
    return (
       <div className="w-screen h-screen top-0 bg-black absolute p-20 flex justify-center items-center">
            <div className="text-3xl text-green-800 font-bold bg-red-50 p-3 z-10 w-16 h-16 rounded-full cursor-pointer absolute top-3 flex justify-center items-center" onClick={() => callBack(false)}>X</div>
